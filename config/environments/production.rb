Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "rails_base_graphql_api_production"
  ...
  config.action_controller.default_url_options = { host: ENV.fetch("HOST", "localhost"), protocol: :https }
